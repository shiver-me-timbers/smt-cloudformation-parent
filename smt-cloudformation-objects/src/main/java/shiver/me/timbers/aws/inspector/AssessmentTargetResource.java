...
public class AssessmentTargetResource
    extends Resource
    implements HasAttributes<AssessmentTargetAttributes> , HasCondition<AssessmentTargetResource> , HasDependsOn<AssessmentTargetResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::Inspector::AssessmentTarget";
    /**
     * AssessmentTarget
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspector-assessmenttarget.html
