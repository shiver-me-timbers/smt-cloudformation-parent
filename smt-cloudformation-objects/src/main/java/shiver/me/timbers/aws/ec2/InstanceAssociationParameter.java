...
public class InstanceAssociationParameter implements Property<InstanceAssociationParameter>
{
    ...
    public InstanceAssociationParameter withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public InstanceAssociationParameter withValue(List<CharSequence> value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InstanceAssociationParameter) == false) {
            return false;
        }
        InstanceAssociationParameter rhs = ((InstanceAssociationParameter) other);
