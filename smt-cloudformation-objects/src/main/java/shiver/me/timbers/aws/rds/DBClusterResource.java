...
public class DBClusterResource
    extends Resource
    implements HasAttributes<DBClusterAttributes> , HasCondition<DBClusterResource> , HasDependsOn<DBClusterResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::RDS::DBCluster";
    /**
     * DBCluster
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbcluster.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbcluster.html")
