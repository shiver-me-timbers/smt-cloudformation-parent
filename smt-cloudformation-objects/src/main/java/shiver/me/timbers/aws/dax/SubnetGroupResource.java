    ...
    implements HasCondition<SubnetGroupResource> , HasDependsOn<SubnetGroupResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::DAX::SubnetGroup";
    /**
     * SubnetGroup
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dax-subnetgroup.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dax-subnetgroup.html")
