...
public class ListenerResource
    extends Resource
    implements HasAttributes<ListenerAttributes> , HasCondition<ListenerResource> , HasDependsOn<ListenerResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::GlobalAccelerator::Listener";
    /**
     * Listener
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-globalaccelerator-listener.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-globalaccelerator-listener.html")
