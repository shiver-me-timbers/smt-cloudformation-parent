...
public class DBProxyTagFormat implements Property<DBProxyTagFormat>
{
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbproxy-tagformat.html#cfn-rds-dbproxy-tagformat-key")
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-dbproxy-tagformat.html#cfn-rds-dbproxy-tagformat-value")
    ...
    public DBProxyTagFormat withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public DBProxyTagFormat withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DBProxyTagFormat) == false) {
            return false;
        }
        DBProxyTagFormat rhs = ((DBProxyTagFormat) other);
