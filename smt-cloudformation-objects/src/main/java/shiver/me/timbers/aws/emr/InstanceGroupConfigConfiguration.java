...
public class InstanceGroupConfigConfiguration implements Property<InstanceGroupConfigConfiguration>
{
    ...
    private Set<Property<shiver.me.timbers.aws.emr.InstanceGroupConfigConfiguration>> configurations = new LinkedHashSet<Property<shiver.me.timbers.aws.emr.InstanceGroupConfigConfiguration>>();
     ...
     */
    @JsonIgnore
    public Set<Property<shiver.me.timbers.aws.emr.InstanceGroupConfigConfiguration>> getConfigurations() {
     ...
     */
    @JsonIgnore
    public void setConfigurations(Set<Property<shiver.me.timbers.aws.emr.InstanceGroupConfigConfiguration>> configurations) {
        this.configurations = configurations;
    }

    public InstanceGroupConfigConfiguration withConfigurations(Set<Property<shiver.me.timbers.aws.emr.InstanceGroupConfigConfiguration>> configurations) {
        this.configurations = configurations;
        return this;
    }
