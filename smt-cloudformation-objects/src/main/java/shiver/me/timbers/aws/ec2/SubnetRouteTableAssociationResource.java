...
public class SubnetRouteTableAssociationResource
    extends Resource
    implements HasCondition<SubnetRouteTableAssociationResource> , HasDependsOn<SubnetRouteTableAssociationResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::EC2::SubnetRouteTableAssociation";
    /**
