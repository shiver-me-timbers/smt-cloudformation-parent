...
public class ImageBuilderVpcConfig implements Property<ImageBuilderVpcConfig>
{
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appstream-imagebuilder-vpcconfig.html#cfn-appstream-imagebuilder-vpcconfig-securitygroupids")
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appstream-imagebuilder-vpcconfig.html#cfn-appstream-imagebuilder-vpcconfig-subnetids")
    ...
    public ImageBuilderVpcConfig withSecurityGroupIds(List<CharSequence> securityGroupIds) {
        this.securityGroupIds = securityGroupIds;
        return this;
    }
    ...
    public ImageBuilderVpcConfig withSubnetIds(List<CharSequence> subnetIds) {
        this.subnetIds = subnetIds;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImageBuilderVpcConfig) == false) {
            return false;
        }
        ImageBuilderVpcConfig rhs = ((ImageBuilderVpcConfig) other);
