...
public class ReplicationGroupNodeGroupConfiguration implements Property<ReplicationGroupNodeGroupConfiguration>
{
    ...
    public ReplicationGroupNodeGroupConfiguration withNodeGroupId(CharSequence nodeGroupId) {
        this.nodeGroupId = nodeGroupId;
        return this;
    }
    ...
    public ReplicationGroupNodeGroupConfiguration withPrimaryAvailabilityZone(CharSequence primaryAvailabilityZone) {
        this.primaryAvailabilityZone = primaryAvailabilityZone;
        return this;
    }
    ...
    public ReplicationGroupNodeGroupConfiguration withReplicaAvailabilityZones(Set<CharSequence> replicaAvailabilityZones) {
        this.replicaAvailabilityZones = replicaAvailabilityZones;
        return this;
    }
    ...
    public ReplicationGroupNodeGroupConfiguration withSlots(CharSequence slots) {
        this.slots = slots;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReplicationGroupNodeGroupConfiguration) == false) {
            return false;
        }
        ReplicationGroupNodeGroupConfiguration rhs = ((ReplicationGroupNodeGroupConfiguration) other);
