...
public class RecordSetGeoLocation implements Property<RecordSetGeoLocation>
{
    ...
    public RecordSetGeoLocation withContinentCode(CharSequence continentCode) {
        this.continentCode = continentCode;
        return this;
    }
    ...
    public RecordSetGeoLocation withCountryCode(CharSequence countryCode) {
        this.countryCode = countryCode;
        return this;
    }
    ...
    public RecordSetGeoLocation withSubdivisionCode(CharSequence subdivisionCode) {
        this.subdivisionCode = subdivisionCode;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordSetGeoLocation) == false) {
            return false;
        }
        RecordSetGeoLocation rhs = ((RecordSetGeoLocation) other);
