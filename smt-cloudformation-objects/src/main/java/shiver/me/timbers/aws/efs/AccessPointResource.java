...
public class AccessPointResource
    extends Resource
    implements HasAttributes<AccessPointAttributes> , HasCondition<AccessPointResource> , HasDependsOn<AccessPointResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::EFS::AccessPoint";
    /**
     * AccessPoint
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-accesspoint.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-efs-accesspoint.html")
