...
public class ImageRecipeEbsInstanceBlockDeviceSpecification implements Property<ImageRecipeEbsInstanceBlockDeviceSpecification>
{
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-encrypted")
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-deleteontermination")
     ...
     */
    @JsonProperty("Iops")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-iops")
    private Number iops;
    /**
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-kmskeyid")
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-snapshotid")
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-volumesize")
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification.html#cfn-imagebuilder-imagerecipe-ebsinstanceblockdevicespecification-volumetype")
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withEncrypted(CharSequence encrypted) {
        this.encrypted = encrypted;
        return this;
    }
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withDeleteOnTermination(CharSequence deleteOnTermination) {
        this.deleteOnTermination = deleteOnTermination;
        return this;
    }
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withIops(Number iops) {
        this.iops = iops;
        return this;
    }
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withKmsKeyId(CharSequence kmsKeyId) {
        this.kmsKeyId = kmsKeyId;
        return this;
    }
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withSnapshotId(CharSequence snapshotId) {
        this.snapshotId = snapshotId;
        return this;
    }
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withVolumeSize(Number volumeSize) {
        this.volumeSize = volumeSize;
        return this;
    }
    ...
    public ImageRecipeEbsInstanceBlockDeviceSpecification withVolumeType(CharSequence volumeType) {
        this.volumeType = volumeType;
        return this;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("encrypted", encrypted).append("deleteOnTermination", deleteOnTermination).append("iops", iops).append("kmsKeyId", kmsKeyId).append("snapshotId", snapshotId).append("volumeSize", volumeSize).append("volumeType", volumeType).toString();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImageRecipeEbsInstanceBlockDeviceSpecification) == false) {
            return false;
        }
        ImageRecipeEbsInstanceBlockDeviceSpecification rhs = ((ImageRecipeEbsInstanceBlockDeviceSpecification) other);
