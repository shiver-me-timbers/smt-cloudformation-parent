...
public class PublicDnsNamespaceResource
    extends Resource
    implements HasAttributes<PublicDnsNamespaceAttributes> , HasCondition<PublicDnsNamespaceResource> , HasDependsOn<PublicDnsNamespaceResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::ServiceDiscovery::PublicDnsNamespace";
    /**
     * PublicDnsNamespace
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicediscovery-publicdnsnamespace.html
