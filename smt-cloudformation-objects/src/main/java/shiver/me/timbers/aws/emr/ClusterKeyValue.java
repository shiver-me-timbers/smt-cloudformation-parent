...
public class ClusterKeyValue implements Property<ClusterKeyValue>
{
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticmapreduce-cluster-keyvalue.html#cfn-elasticmapreduce-cluster-keyvalue-key")
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticmapreduce-cluster-keyvalue.html#cfn-elasticmapreduce-cluster-keyvalue-value")
    ...
    public ClusterKeyValue withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public ClusterKeyValue withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClusterKeyValue) == false) {
            return false;
        }
        ClusterKeyValue rhs = ((ClusterKeyValue) other);
