...
public class TaskDefinitionKeyValuePair implements Property<TaskDefinitionKeyValuePair>
{
    ...
    public TaskDefinitionKeyValuePair withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public TaskDefinitionKeyValuePair withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TaskDefinitionKeyValuePair) == false) {
            return false;
        }
        TaskDefinitionKeyValuePair rhs = ((TaskDefinitionKeyValuePair) other);
