...
public class InstanceFleetConfigResource
    extends Resource
    implements HasCondition<InstanceFleetConfigResource> , HasDependsOn<InstanceFleetConfigResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::EMR::InstanceFleetConfig";
    /**
     * InstanceFleetConfig
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticmapreduce-instancefleetconfig.html
    ...
    @Override
    public InstanceFleetConfigResource withCondition(java.lang.String condition) {
