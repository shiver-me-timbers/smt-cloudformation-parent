...
public class DeploymentStrategyTags implements Property<DeploymentStrategyTags>
{
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appconfig-deploymentstrategy-tags.html#cfn-appconfig-deploymentstrategy-tags-value")
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appconfig-deploymentstrategy-tags.html#cfn-appconfig-deploymentstrategy-tags-key")
    ...
    public DeploymentStrategyTags withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public DeploymentStrategyTags withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeploymentStrategyTags) == false) {
            return false;
        }
        DeploymentStrategyTags rhs = ((DeploymentStrategyTags) other);
