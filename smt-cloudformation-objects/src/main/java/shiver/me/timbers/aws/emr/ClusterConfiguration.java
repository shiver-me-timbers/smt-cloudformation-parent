...
public class ClusterConfiguration implements Property<ClusterConfiguration>
{
    ...
    private Set<Property<shiver.me.timbers.aws.emr.ClusterConfiguration>> configurations = new LinkedHashSet<Property<shiver.me.timbers.aws.emr.ClusterConfiguration>>();
    ...
    public ClusterConfiguration withConfigurationProperties(Map<String, CharSequence> configurationProperties) {
        this.configurationProperties = configurationProperties;
        return this;
    }
     ...
     */
    @JsonIgnore
    public Set<Property<shiver.me.timbers.aws.emr.ClusterConfiguration>> getConfigurations() {
     ...
     */
    @JsonIgnore
    public void setConfigurations(Set<Property<shiver.me.timbers.aws.emr.ClusterConfiguration>> configurations) {
        this.configurations = configurations;
    }

    public ClusterConfiguration withConfigurations(Set<Property<shiver.me.timbers.aws.emr.ClusterConfiguration>> configurations) {
        this.configurations = configurations;
        return this;
    }
