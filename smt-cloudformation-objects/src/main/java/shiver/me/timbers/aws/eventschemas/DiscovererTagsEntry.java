...
public class DiscovererTagsEntry implements Property<DiscovererTagsEntry>
{
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eventschemas-discoverer-tagsentry.html#cfn-eventschemas-discoverer-tagsentry-value")
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eventschemas-discoverer-tagsentry.html#cfn-eventschemas-discoverer-tagsentry-key")
    ...
    public DiscovererTagsEntry withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public DiscovererTagsEntry withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DiscovererTagsEntry) == false) {
            return false;
        }
        DiscovererTagsEntry rhs = ((DiscovererTagsEntry) other);
