    ...
    implements HasCondition<CertificateResource> , HasDependsOn<CertificateResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::DMS::Certificate";
    /**
     * Certificate
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dms-certificate.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dms-certificate.html")
