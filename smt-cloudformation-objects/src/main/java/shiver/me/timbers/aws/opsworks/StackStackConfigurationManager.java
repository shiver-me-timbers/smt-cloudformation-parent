...
public class StackStackConfigurationManager implements Property<StackStackConfigurationManager>
{
    ...
    public StackStackConfigurationManager withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public StackStackConfigurationManager withVersion(CharSequence version) {
        this.version = version;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StackStackConfigurationManager) == false) {
            return false;
        }
        StackStackConfigurationManager rhs = ((StackStackConfigurationManager) other);
