    ...
    implements HasCondition<TableResource> , HasDependsOn<TableResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::Cassandra::Table";
    /**
     * Table
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cassandra-table.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cassandra-table.html")
