    ...
    implements HasAttributes<GroupAttributes> , HasCondition<GroupResource> , HasDependsOn<GroupResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::ResourceGroups::Group";
    /**
     * Group
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-resourcegroups-group.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-resourcegroups-group.html")
