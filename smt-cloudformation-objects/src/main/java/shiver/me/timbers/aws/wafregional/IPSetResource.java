...
public class IPSetResource
    extends Resource
    implements HasCondition<IPSetResource> , HasDependsOn<IPSetResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::WAFRegional::IPSet";
    /**
     * IPSet
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ipset.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ipset.html")
