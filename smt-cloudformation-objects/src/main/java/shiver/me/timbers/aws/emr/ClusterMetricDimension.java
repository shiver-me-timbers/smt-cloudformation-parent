...
public class ClusterMetricDimension implements Property<ClusterMetricDimension>
{
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticmapreduce-cluster-metricdimension.html#cfn-elasticmapreduce-cluster-metricdimension-key")
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticmapreduce-cluster-metricdimension.html#cfn-elasticmapreduce-cluster-metricdimension-value")
    ...
    public ClusterMetricDimension withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public ClusterMetricDimension withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClusterMetricDimension) == false) {
            return false;
        }
        ClusterMetricDimension rhs = ((ClusterMetricDimension) other);
