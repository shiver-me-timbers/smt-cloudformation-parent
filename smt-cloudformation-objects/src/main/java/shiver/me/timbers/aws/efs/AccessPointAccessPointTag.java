...
public class AccessPointAccessPointTag implements Property<AccessPointAccessPointTag>
{
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-efs-accesspoint-accesspointtag.html#cfn-efs-accesspoint-accesspointtag-key")
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-efs-accesspoint-accesspointtag.html#cfn-efs-accesspoint-accesspointtag-value")
    ...
    public AccessPointAccessPointTag withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public AccessPointAccessPointTag withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccessPointAccessPointTag) == false) {
            return false;
        }
        AccessPointAccessPointTag rhs = ((AccessPointAccessPointTag) other);
