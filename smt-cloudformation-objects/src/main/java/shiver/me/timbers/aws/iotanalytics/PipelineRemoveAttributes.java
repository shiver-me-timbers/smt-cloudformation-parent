...
public class PipelineRemoveAttributes implements Property<PipelineRemoveAttributes>
{
    ...
    public PipelineRemoveAttributes withNext(CharSequence next) {
        this.next = next;
        return this;
    }
    ...
    public PipelineRemoveAttributes withAttributes(List<CharSequence> attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public PipelineRemoveAttributes withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PipelineRemoveAttributes) == false) {
            return false;
        }
        PipelineRemoveAttributes rhs = ((PipelineRemoveAttributes) other);
