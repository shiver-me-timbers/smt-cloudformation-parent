...
public class SchemaTagsEntry implements Property<SchemaTagsEntry>
{
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eventschemas-schema-tagsentry.html#cfn-eventschemas-schema-tagsentry-value")
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-eventschemas-schema-tagsentry.html#cfn-eventschemas-schema-tagsentry-key")
    ...
    public SchemaTagsEntry withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public SchemaTagsEntry withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SchemaTagsEntry) == false) {
            return false;
        }
        SchemaTagsEntry rhs = ((SchemaTagsEntry) other);
