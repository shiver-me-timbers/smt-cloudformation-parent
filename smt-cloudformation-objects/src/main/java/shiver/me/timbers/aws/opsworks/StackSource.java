...
public class StackSource implements Property<StackSource>
{
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opsworks-stack-source.html#cfn-opsworks-custcookbooksource-password")
    ...
    public StackSource withPassword(CharSequence password) {
        this.password = password;
        return this;
    }
    ...
    public StackSource withRevision(CharSequence revision) {
        this.revision = revision;
        return this;
    }
    ...
    public StackSource withSshKey(CharSequence sshKey) {
        this.sshKey = sshKey;
        return this;
    }
    ...
    public StackSource withType(CharSequence type) {
        this.type = type;
        return this;
    }
    ...
    public StackSource withUrl(CharSequence url) {
        this.url = url;
        return this;
    }
    ...
    public StackSource withUsername(CharSequence username) {
        this.username = username;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StackSource) == false) {
            return false;
        }
        StackSource rhs = ((StackSource) other);
