    ...
    implements HasCondition<DeploymentResource> , HasDependsOn<DeploymentResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::AppConfig::Deployment";
    /**
     * Deployment
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-deployment.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-deployment.html")
