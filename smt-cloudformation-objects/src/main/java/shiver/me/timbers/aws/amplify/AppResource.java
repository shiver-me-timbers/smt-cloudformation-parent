    ...
    implements HasAttributes<AppAttributes> , HasCondition<AppResource> , HasDependsOn<AppResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::Amplify::App";
    /**
     * App
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-amplify-app.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-amplify-app.html")
