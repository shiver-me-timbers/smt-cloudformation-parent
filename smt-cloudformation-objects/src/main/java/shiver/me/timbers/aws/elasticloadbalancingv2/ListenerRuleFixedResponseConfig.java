...
public class ListenerRuleFixedResponseConfig implements Property<ListenerRuleFixedResponseConfig>
{
    ...
    public ListenerRuleFixedResponseConfig withContentType(CharSequence contentType) {
        this.contentType = contentType;
        return this;
    }
    ...
    public ListenerRuleFixedResponseConfig withMessageBody(CharSequence messageBody) {
        this.messageBody = messageBody;
        return this;
    }
    ...
    public ListenerRuleFixedResponseConfig withStatusCode(CharSequence statusCode) {
        this.statusCode = statusCode;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ListenerRuleFixedResponseConfig) == false) {
            return false;
        }
        ListenerRuleFixedResponseConfig rhs = ((ListenerRuleFixedResponseConfig) other);
