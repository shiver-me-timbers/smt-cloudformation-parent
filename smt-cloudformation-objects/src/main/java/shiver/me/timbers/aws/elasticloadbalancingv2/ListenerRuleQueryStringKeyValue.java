...
public class ListenerRuleQueryStringKeyValue implements Property<ListenerRuleQueryStringKeyValue>
{
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-listenerrule-querystringkeyvalue.html#cfn-elasticloadbalancingv2-listenerrule-querystringkeyvalue-key")
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-listenerrule-querystringkeyvalue.html#cfn-elasticloadbalancingv2-listenerrule-querystringkeyvalue-value")
    ...
    public ListenerRuleQueryStringKeyValue withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public ListenerRuleQueryStringKeyValue withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ListenerRuleQueryStringKeyValue) == false) {
            return false;
        }
        ListenerRuleQueryStringKeyValue rhs = ((ListenerRuleQueryStringKeyValue) other);
