    ...
    implements HasAttributes<EndpointAttributes> , HasCondition<EndpointResource> , HasDependsOn<EndpointResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::SageMaker::Endpoint";
    /**
     * Endpoint
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-endpoint.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-endpoint.html")
