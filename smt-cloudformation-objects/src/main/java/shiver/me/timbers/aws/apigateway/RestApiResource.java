...
public class RestApiResource
    extends Resource
    implements HasAttributes<RestApiAttributes> , HasCondition<RestApiResource> , HasDependsOn<RestApiResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::ApiGateway::RestApi";
    /**
     * RestApi
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-restapi.html
