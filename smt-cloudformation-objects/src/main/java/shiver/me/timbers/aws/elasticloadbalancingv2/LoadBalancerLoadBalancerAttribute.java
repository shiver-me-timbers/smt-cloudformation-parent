...
public class LoadBalancerLoadBalancerAttribute implements Property<LoadBalancerLoadBalancerAttribute>
{
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-loadbalancer-loadbalancerattributes.html#cfn-elasticloadbalancingv2-loadbalancer-loadbalancerattributes-key")
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticloadbalancingv2-loadbalancer-loadbalancerattributes.html#cfn-elasticloadbalancingv2-loadbalancer-loadbalancerattributes-value")
    ...
    public LoadBalancerLoadBalancerAttribute withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public LoadBalancerLoadBalancerAttribute withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LoadBalancerLoadBalancerAttribute) == false) {
            return false;
        }
        LoadBalancerLoadBalancerAttribute rhs = ((LoadBalancerLoadBalancerAttribute) other);
