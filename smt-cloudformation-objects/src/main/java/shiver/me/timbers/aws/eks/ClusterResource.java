    ...
    implements HasAttributes<ClusterAttributes> , HasCondition<ClusterResource> , HasDependsOn<ClusterResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::EKS::Cluster";
    /**
     * Cluster
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-cluster.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-cluster.html")
