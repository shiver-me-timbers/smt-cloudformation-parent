...
public class DomainNameResource
    extends Resource
    implements HasAttributes<DomainNameAttributes> , HasCondition<DomainNameResource> , HasDependsOn<DomainNameResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::ApiGateway::DomainName";
    /**
     * DomainName
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-domainname.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-domainname.html")
