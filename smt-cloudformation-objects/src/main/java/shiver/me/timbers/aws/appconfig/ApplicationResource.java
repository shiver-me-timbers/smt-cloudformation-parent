    ...
    implements HasCondition<ApplicationResource> , HasDependsOn<ApplicationResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::AppConfig::Application";
    /**
     * Application
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-application.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-application.html")
