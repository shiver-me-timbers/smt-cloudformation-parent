    ...
    implements HasAttributes<ClusterAttributes> , HasCondition<ClusterResource> , HasDependsOn<ClusterResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::Redshift::Cluster";
    /**
     * Cluster
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html")
