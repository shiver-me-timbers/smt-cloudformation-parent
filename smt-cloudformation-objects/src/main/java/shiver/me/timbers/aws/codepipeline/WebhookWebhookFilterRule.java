...
public class WebhookWebhookFilterRule implements Property<WebhookWebhookFilterRule>
{
    ...
    public WebhookWebhookFilterRule withJsonPath(CharSequence jsonPath) {
        this.jsonPath = jsonPath;
        return this;
    }
    ...
    public WebhookWebhookFilterRule withMatchEquals(CharSequence matchEquals) {
        this.matchEquals = matchEquals;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WebhookWebhookFilterRule) == false) {
            return false;
        }
        WebhookWebhookFilterRule rhs = ((WebhookWebhookFilterRule) other);
