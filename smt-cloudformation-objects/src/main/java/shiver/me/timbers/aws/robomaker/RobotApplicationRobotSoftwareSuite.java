...
public class RobotApplicationRobotSoftwareSuite implements Property<RobotApplicationRobotSoftwareSuite>
{
    ...
    public RobotApplicationRobotSoftwareSuite withVersion(CharSequence version) {
        this.version = version;
        return this;
    }
    ...
    public RobotApplicationRobotSoftwareSuite withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RobotApplicationRobotSoftwareSuite) == false) {
            return false;
        }
        RobotApplicationRobotSoftwareSuite rhs = ((RobotApplicationRobotSoftwareSuite) other);
