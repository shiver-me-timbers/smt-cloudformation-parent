...
public class DataSourceAwsIamConfig implements Property<DataSourceAwsIamConfig>
{
    ...
    public DataSourceAwsIamConfig withSigningRegion(CharSequence signingRegion) {
        this.signingRegion = signingRegion;
        return this;
    }
    ...
    public DataSourceAwsIamConfig withSigningServiceName(CharSequence signingServiceName) {
        this.signingServiceName = signingServiceName;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataSourceAwsIamConfig) == false) {
            return false;
        }
        DataSourceAwsIamConfig rhs = ((DataSourceAwsIamConfig) other);
