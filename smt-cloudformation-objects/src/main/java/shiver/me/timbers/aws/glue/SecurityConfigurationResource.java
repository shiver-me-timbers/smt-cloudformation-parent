    ...
    implements HasCondition<SecurityConfigurationResource> , HasDependsOn<SecurityConfigurationResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::Glue::SecurityConfiguration";
    /**
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-securityconfiguration.html")
