...
public class CreateRule implements Property<CreateRule>
{
    ...
    public CreateRule withIntervalUnit(CharSequence intervalUnit) {
        this.intervalUnit = intervalUnit;
        return this;
    }
    ...
    public CreateRule withTimes(List<CharSequence> times) {
        this.times = times;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CreateRule) == false) {
            return false;
        }
        CreateRule rhs = ((CreateRule) other);
