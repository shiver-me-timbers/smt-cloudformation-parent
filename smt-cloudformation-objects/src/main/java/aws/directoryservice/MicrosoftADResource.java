...
public class MicrosoftADResource
    extends Resource
    implements HasAttributes<MicrosoftADAttributes> , HasCondition<MicrosoftADResource> , HasDependsOn<MicrosoftADResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::DirectoryService::MicrosoftAD";
    /**
     * MicrosoftAD
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-directoryservice-microsoftad.html
