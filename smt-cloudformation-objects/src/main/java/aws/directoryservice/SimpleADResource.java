...
public class SimpleADResource
    extends Resource
    implements HasAttributes<SimpleADAttributes> , HasCondition<SimpleADResource> , HasDependsOn<SimpleADResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::DirectoryService::SimpleAD";
    /**
     * SimpleAD
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-directoryservice-simplead.html
