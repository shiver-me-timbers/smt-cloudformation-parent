    ...
    implements HasAttributes<ClusterAttributes> , HasCondition<ClusterResource> , HasDependsOn<ClusterResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::DAX::Cluster";
    /**
     * Cluster
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dax-cluster.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dax-cluster.html")
