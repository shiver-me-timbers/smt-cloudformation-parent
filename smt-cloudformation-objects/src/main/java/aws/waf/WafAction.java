...
public class WafAction implements Property<WafAction>
{
    ...
    public WafAction withType(CharSequence type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WafAction) == false) {
            return false;
        }
        WafAction rhs = ((WafAction) other);
