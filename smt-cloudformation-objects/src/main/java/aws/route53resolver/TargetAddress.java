...
public class TargetAddress implements Property<TargetAddress>
{
    ...
    public TargetAddress withIp(CharSequence ip) {
        this.ip = ip;
        return this;
    }
    ...
    public TargetAddress withPort(CharSequence port) {
        this.port = port;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TargetAddress) == false) {
            return false;
        }
        TargetAddress rhs = ((TargetAddress) other);
