...
public class InstanceBlockDeviceMapping implements Property<InstanceBlockDeviceMapping>
{
    ...
    private Property<InstanceEbsBlockDevice> ebs;
    /**
     ...
     */
    @JsonIgnore
    public Property<InstanceEbsBlockDevice> getEbs() {
        return ebs;
    }
     ...
     */
    @JsonIgnore
    public void setEbs(Property<InstanceEbsBlockDevice> ebs) {
        this.ebs = ebs;
    }

    public InstanceBlockDeviceMapping withEbs(Property<InstanceEbsBlockDevice> ebs) {
        this.ebs = ebs;
        return this;
    }
    ...
    public InstanceBlockDeviceMapping withNoDevice(CharSequence noDevice) {
        this.noDevice = noDevice;
        return this;
    }
