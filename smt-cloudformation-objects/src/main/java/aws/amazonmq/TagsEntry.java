...
public class TagsEntry implements Property<TagsEntry>
{
    ...
    public TagsEntry withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public TagsEntry withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TagsEntry) == false) {
            return false;
        }
        TagsEntry rhs = ((TagsEntry) other);
