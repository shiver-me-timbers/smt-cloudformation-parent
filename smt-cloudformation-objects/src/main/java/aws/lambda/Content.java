...
public class Content implements Property<Content>
{
    ...
    public Content withS3ObjectVersion(CharSequence s3ObjectVersion) {
        this.s3ObjectVersion = s3ObjectVersion;
        return this;
    }
    ...
    public Content withS3Bucket(CharSequence s3Bucket) {
        this.s3Bucket = s3Bucket;
        return this;
    }
    ...
    public Content withS3Key(CharSequence s3Key) {
        this.s3Key = s3Key;
        return this;
    }
