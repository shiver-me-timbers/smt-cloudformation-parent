...
public class FunctionCode implements Property<FunctionCode>
{
    ...
    public FunctionCode withS3Bucket(CharSequence s3Bucket) {
        this.s3Bucket = s3Bucket;
        return this;
    }
    ...
    public FunctionCode withS3Key(CharSequence s3Key) {
        this.s3Key = s3Key;
        return this;
    }
    ...
    public FunctionCode withS3ObjectVersion(CharSequence s3ObjectVersion) {
        this.s3ObjectVersion = s3ObjectVersion;
        return this;
    }
    ...
    public FunctionCode withZipFile(CharSequence zipFile) {
        this.zipFile = zipFile;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FunctionCode) == false) {
            return false;
        }
        FunctionCode rhs = ((FunctionCode) other);
