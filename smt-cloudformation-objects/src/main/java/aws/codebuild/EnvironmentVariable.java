...
public class EnvironmentVariable implements Property<EnvironmentVariable>
{
    ...
    public EnvironmentVariable withType(CharSequence type) {
        this.type = type;
        return this;
    }
    ...
    public EnvironmentVariable withName(CharSequence name) {
        this.name = name;
        return this;
    }
