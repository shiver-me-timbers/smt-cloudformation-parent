...
public class WebhookFilter implements Property<WebhookFilter>
{
    ...
    public WebhookFilter withPattern(CharSequence pattern) {
        this.pattern = pattern;
        return this;
    }
    ...
    public WebhookFilter withType(CharSequence type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WebhookFilter) == false) {
            return false;
        }
        WebhookFilter rhs = ((WebhookFilter) other);
