...
public class RecordSetAliasTarget implements Property<RecordSetAliasTarget>
{
    ...
    public RecordSetAliasTarget withDNSName(CharSequence dNSName) {
        this.dNSName = dNSName;
        return this;
    }
    ...
    public RecordSetAliasTarget withHostedZoneId(CharSequence hostedZoneId) {
        this.hostedZoneId = hostedZoneId;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RecordSetAliasTarget) == false) {
            return false;
        }
        RecordSetAliasTarget rhs = ((RecordSetAliasTarget) other);
