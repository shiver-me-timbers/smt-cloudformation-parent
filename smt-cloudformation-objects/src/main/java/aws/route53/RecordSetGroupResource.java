...
public class RecordSetGroupResource
    extends Resource
    implements HasCondition<RecordSetGroupResource> , HasDependsOn<RecordSetGroupResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::Route53::RecordSetGroup";
    /**
     * RecordSetGroup
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53-recordsetgroup.html
     ...
     * @param name
     */
    public RecordSetGroupResource(java.lang.String name) {
        super(name);
    }
    ...
    @Override
    public RecordSetGroupResource withCondition(java.lang.String condition) {
    ...
    @Override
    public RecordSetGroupResource withName(java.lang.String name) {
        super.withName(name);
        return this;
    }
