...
public class CloudFormationProvisionedProductProvisioningParameter implements Property<CloudFormationProvisionedProductProvisioningParameter>
{
    ...
    public CloudFormationProvisionedProductProvisioningParameter withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public CloudFormationProvisionedProductProvisioningParameter withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CloudFormationProvisionedProductProvisioningParameter) == false) {
            return false;
        }
        CloudFormationProvisionedProductProvisioningParameter rhs = ((CloudFormationProvisionedProductProvisioningParameter) other);
