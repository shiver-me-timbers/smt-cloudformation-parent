...
public class TagOptionResource
    extends Resource
    implements HasCondition<TagOptionResource> , HasDependsOn<TagOptionResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::ServiceCatalog::TagOption";
    /**
     * TagOption
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-tagoption.html
    ...
    @Override
    public TagOptionResource withCondition(java.lang.String condition) {
