...
public class KeyValuePair implements Property<KeyValuePair>
{
    ...
    public KeyValuePair withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public KeyValuePair withValue(CharSequence value) {
        this.value = value;
        return this;
    }
