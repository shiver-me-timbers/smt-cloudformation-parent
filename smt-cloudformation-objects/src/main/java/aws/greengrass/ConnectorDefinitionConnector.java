...
public class ConnectorDefinitionConnector implements Property<ConnectorDefinitionConnector>
{
    ...
    public ConnectorDefinitionConnector withConnectorArn(CharSequence connectorArn) {
        this.connectorArn = connectorArn;
        return this;
    }
    ...
    public ConnectorDefinitionConnector withParameters(Object parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public ConnectorDefinitionConnector withId(CharSequence id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConnectorDefinitionConnector) == false) {
            return false;
        }
        ConnectorDefinitionConnector rhs = ((ConnectorDefinitionConnector) other);
