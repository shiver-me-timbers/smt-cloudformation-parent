...
public class RunAs implements Property<RunAs>
{
    ...
    public RunAs withUid(Integer uid) {
        this.uid = uid;
        return this;
    }
    ...
    public RunAs withGid(Integer gid) {
        this.gid = gid;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RunAs) == false) {
            return false;
        }
        RunAs rhs = ((RunAs) other);
