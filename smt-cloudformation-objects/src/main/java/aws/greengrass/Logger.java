...
public class Logger implements Property<Logger>
{
    ...
    public Logger withType(CharSequence type) {
        this.type = type;
        return this;
    }
    ...
    public Logger withLevel(CharSequence level) {
        this.level = level;
        return this;
    }
    ...
    public Logger withId(CharSequence id) {
        this.id = id;
        return this;
    }
    ...
    public Logger withComponent(CharSequence component) {
        this.component = component;
        return this;
    }
