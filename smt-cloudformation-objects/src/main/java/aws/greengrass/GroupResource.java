    ...
    implements HasAttributes<GroupAttributes> , HasCondition<GroupResource> , HasDependsOn<GroupResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::Greengrass::Group";
    /**
     * Group
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-group.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-group.html")
