...
public class ResourceDefinitionSecretsManagerSecretResourceData implements Property<ResourceDefinitionSecretsManagerSecretResourceData>
{
    ...
    public ResourceDefinitionSecretsManagerSecretResourceData withARN(CharSequence aRN) {
        this.aRN = aRN;
        return this;
    }
    ...
    public ResourceDefinitionSecretsManagerSecretResourceData withAdditionalStagingLabelsToDownload(List<CharSequence> additionalStagingLabelsToDownload) {
        this.additionalStagingLabelsToDownload = additionalStagingLabelsToDownload;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResourceDefinitionSecretsManagerSecretResourceData) == false) {
            return false;
        }
        ResourceDefinitionSecretsManagerSecretResourceData rhs = ((ResourceDefinitionSecretsManagerSecretResourceData) other);
