...
public class SageMakerMachineLearningModelResourceData implements Property<SageMakerMachineLearningModelResourceData>
{
    ...
    public SageMakerMachineLearningModelResourceData withDestinationPath(CharSequence destinationPath) {
        this.destinationPath = destinationPath;
        return this;
    }
    ...
    public SageMakerMachineLearningModelResourceData withSageMakerJobArn(CharSequence sageMakerJobArn) {
        this.sageMakerJobArn = sageMakerJobArn;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SageMakerMachineLearningModelResourceData) == false) {
            return false;
        }
        SageMakerMachineLearningModelResourceData rhs = ((SageMakerMachineLearningModelResourceData) other);
