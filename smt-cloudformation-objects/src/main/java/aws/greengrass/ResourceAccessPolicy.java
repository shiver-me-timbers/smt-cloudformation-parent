...
public class ResourceAccessPolicy implements Property<ResourceAccessPolicy>
{
    ...
    public ResourceAccessPolicy withResourceId(CharSequence resourceId) {
        this.resourceId = resourceId;
        return this;
    }
    ...
    public ResourceAccessPolicy withPermission(CharSequence permission) {
        this.permission = permission;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResourceAccessPolicy) == false) {
            return false;
        }
        ResourceAccessPolicy rhs = ((ResourceAccessPolicy) other);
