...
public class GroupOwnerSetting implements Property<GroupOwnerSetting>
{
    ...
    public GroupOwnerSetting withGroupOwner(CharSequence groupOwner) {
        this.groupOwner = groupOwner;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GroupOwnerSetting) == false) {
            return false;
        }
        GroupOwnerSetting rhs = ((GroupOwnerSetting) other);
