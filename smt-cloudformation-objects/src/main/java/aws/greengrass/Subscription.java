...
public class Subscription implements Property<Subscription>
{
    ...
    public Subscription withTarget(CharSequence target) {
        this.target = target;
        return this;
    }
    ...
    public Subscription withId(CharSequence id) {
        this.id = id;
        return this;
    }
    ...
    public Subscription withSource(CharSequence source) {
        this.source = source;
        return this;
    }
    ...
    public Subscription withSubject(CharSequence subject) {
        this.subject = subject;
        return this;
    }
