    ...
    implements HasCondition<DBClusterParameterGroupResource> , HasDependsOn<DBClusterParameterGroupResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::RDS::DBClusterParameterGroup";
    /**
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbclusterparametergroup.html")
