...
public class DBSecurityGroupIngressResource
    extends Resource
    implements HasCondition<DBSecurityGroupIngressResource> , HasDependsOn<DBSecurityGroupIngressResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::RDS::DBSecurityGroupIngress";
    /**
