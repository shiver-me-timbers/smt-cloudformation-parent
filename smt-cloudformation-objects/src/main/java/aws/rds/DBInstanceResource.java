...
public class DBInstanceResource
    extends Resource
    implements HasAttributes<DBInstanceAttributes> , HasCondition<DBInstanceResource> , HasDependsOn<DBInstanceResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::RDS::DBInstance";
    /**
     * DBInstance
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-database-instance.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-rds-database-instance.html")
