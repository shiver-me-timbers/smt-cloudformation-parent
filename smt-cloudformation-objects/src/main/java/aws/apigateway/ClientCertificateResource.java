...
public class ClientCertificateResource
    extends Resource
    implements HasCondition<ClientCertificateResource> , HasDependsOn<ClientCertificateResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::ApiGateway::ClientCertificate";
    /**
     * ClientCertificate
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-clientcertificate.html
