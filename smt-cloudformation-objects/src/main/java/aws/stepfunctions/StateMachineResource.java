...
public class StateMachineResource
    extends Resource
    implements HasAttributes<StateMachineAttributes> , HasCondition<StateMachineResource> , HasDependsOn<StateMachineResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::StepFunctions::StateMachine";
    /**
     * StateMachine
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-stepfunctions-statemachine.html
