...
public class PipelinePipelineTag implements Property<PipelinePipelineTag>
{
    ...
    public PipelinePipelineTag withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public PipelinePipelineTag withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PipelinePipelineTag) == false) {
            return false;
        }
        PipelinePipelineTag rhs = ((PipelinePipelineTag) other);
