...
public class AddAttributes implements Property<AddAttributes>
{
    ...
    public AddAttributes withNext(CharSequence next) {
        this.next = next;
        return this;
    }
    ...
    public AddAttributes withAttributes(Object attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public AddAttributes withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddAttributes) == false) {
            return false;
        }
        AddAttributes rhs = ((AddAttributes) other);
