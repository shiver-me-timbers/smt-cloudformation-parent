...
public class OutputArtifact implements Property<OutputArtifact>
{
    ...
    public OutputArtifact withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OutputArtifact) == false) {
            return false;
        }
        OutputArtifact rhs = ((OutputArtifact) other);
