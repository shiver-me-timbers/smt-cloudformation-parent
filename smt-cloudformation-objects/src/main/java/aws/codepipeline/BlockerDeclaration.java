...
public class BlockerDeclaration implements Property<BlockerDeclaration>
{
    ...
    public BlockerDeclaration withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public BlockerDeclaration withType(CharSequence type) {
        this.type = type;
        return this;
    }
