...
public class DomainJoinInfo implements Property<DomainJoinInfo>
{
    ...
    public DomainJoinInfo withOrganizationalUnitDistinguishedName(CharSequence organizationalUnitDistinguishedName) {
        this.organizationalUnitDistinguishedName = organizationalUnitDistinguishedName;
        return this;
    }
    ...
    public DomainJoinInfo withDirectoryName(CharSequence directoryName) {
        this.directoryName = directoryName;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DomainJoinInfo) == false) {
            return false;
        }
        DomainJoinInfo rhs = ((DomainJoinInfo) other);
