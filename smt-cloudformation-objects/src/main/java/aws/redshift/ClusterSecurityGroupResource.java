...
public class ClusterSecurityGroupResource
    extends Resource
    implements HasCondition<ClusterSecurityGroupResource> , HasDependsOn<ClusterSecurityGroupResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::Redshift::ClusterSecurityGroup";
    /**
