...
public class ClusterParameterGroupResource
    extends Resource
    implements HasCondition<ClusterParameterGroupResource> , HasDependsOn<ClusterParameterGroupResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::Redshift::ClusterParameterGroup";
    /**
