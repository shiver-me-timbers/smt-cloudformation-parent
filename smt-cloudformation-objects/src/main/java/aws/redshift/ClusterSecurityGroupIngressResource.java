...
public class ClusterSecurityGroupIngressResource
    extends Resource
    implements HasCondition<ClusterSecurityGroupIngressResource> , HasDependsOn<ClusterSecurityGroupIngressResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::Redshift::ClusterSecurityGroupIngress";
    /**
