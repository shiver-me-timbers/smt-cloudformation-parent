...
public class IdentityTags implements Property<IdentityTags>
{
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpointemail-identity-tags.html#cfn-pinpointemail-identity-tags-value")
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpointemail-identity-tags.html#cfn-pinpointemail-identity-tags-key")
    ...
    public IdentityTags withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public IdentityTags withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IdentityTags) == false) {
            return false;
        }
        IdentityTags rhs = ((IdentityTags) other);
