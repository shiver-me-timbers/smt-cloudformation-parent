    ...
    implements HasCondition<ConfigurationSetEventDestinationResource> , HasDependsOn<ConfigurationSetEventDestinationResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::PinpointEmail::ConfigurationSetEventDestination";
    /**
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpointemail-configurationseteventdestination.html")
