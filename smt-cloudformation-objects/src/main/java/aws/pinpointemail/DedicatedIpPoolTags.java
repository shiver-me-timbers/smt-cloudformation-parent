...
public class DedicatedIpPoolTags implements Property<DedicatedIpPoolTags>
{
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpointemail-dedicatedippool-tags.html#cfn-pinpointemail-dedicatedippool-tags-value")
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-pinpointemail-dedicatedippool-tags.html#cfn-pinpointemail-dedicatedippool-tags-key")
    ...
    public DedicatedIpPoolTags withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public DedicatedIpPoolTags withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DedicatedIpPoolTags) == false) {
            return false;
        }
        DedicatedIpPoolTags rhs = ((DedicatedIpPoolTags) other);
