    ...
    implements HasCondition<SecurityGroupIngressResource> , HasDependsOn<SecurityGroupIngressResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::ElastiCache::SecurityGroupIngress";
    /**
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-security-group-ingress.html")
