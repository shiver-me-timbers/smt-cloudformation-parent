...
public class RegexPatternSetResource
    extends Resource
    implements HasCondition<RegexPatternSetResource> , HasDependsOn<RegexPatternSetResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::WAFRegional::RegexPatternSet";
    /**
     * RegexPatternSet
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-regexpatternset.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-regexpatternset.html")
