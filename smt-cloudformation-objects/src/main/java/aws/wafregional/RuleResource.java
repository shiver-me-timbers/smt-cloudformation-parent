    ...
    extends Resource
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::WAFRegional::Rule";
    /**
     * Rule
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-rule.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-rule.html")
