...
public class LoadBalancerAttribute implements Property<LoadBalancerAttribute>
{
    ...
    public LoadBalancerAttribute withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public LoadBalancerAttribute withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LoadBalancerAttribute) == false) {
            return false;
        }
        LoadBalancerAttribute rhs = ((LoadBalancerAttribute) other);
