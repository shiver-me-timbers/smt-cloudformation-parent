...
public class TargetGroupAttribute implements Property<TargetGroupAttribute>
{
    ...
    public TargetGroupAttribute withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public TargetGroupAttribute withValue(CharSequence value) {
        this.value = value;
        return this;
    }
