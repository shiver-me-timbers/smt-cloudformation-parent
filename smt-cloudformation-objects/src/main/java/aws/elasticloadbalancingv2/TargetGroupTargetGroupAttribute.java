...
public class TargetGroupTargetGroupAttribute implements Property<TargetGroupTargetGroupAttribute>
{
    ...
    public TargetGroupTargetGroupAttribute withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public TargetGroupTargetGroupAttribute withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TargetGroupTargetGroupAttribute) == false) {
            return false;
        }
        TargetGroupTargetGroupAttribute rhs = ((TargetGroupTargetGroupAttribute) other);
