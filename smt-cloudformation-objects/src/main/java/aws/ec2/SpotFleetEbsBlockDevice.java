...
public class SpotFleetEbsBlockDevice implements Property<SpotFleetEbsBlockDevice>
{
    ...
    public SpotFleetEbsBlockDevice withSnapshotId(CharSequence snapshotId) {
        this.snapshotId = snapshotId;
        return this;
    }
    ...
    public SpotFleetEbsBlockDevice withVolumeType(CharSequence volumeType) {
        this.volumeType = volumeType;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpotFleetEbsBlockDevice) == false) {
            return false;
        }
        SpotFleetEbsBlockDevice rhs = ((SpotFleetEbsBlockDevice) other);
