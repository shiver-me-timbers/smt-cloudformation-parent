...
public class HibernationOptions implements Property<HibernationOptions>
{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HibernationOptions) == false) {
            return false;
        }
        HibernationOptions rhs = ((HibernationOptions) other);
