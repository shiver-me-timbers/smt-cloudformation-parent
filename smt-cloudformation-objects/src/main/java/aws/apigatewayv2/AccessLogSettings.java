...
public class AccessLogSettings implements Property<AccessLogSettings>
{
    ...
    public AccessLogSettings withFormat(CharSequence format) {
        this.format = format;
        return this;
    }
    ...
    public AccessLogSettings withDestinationArn(CharSequence destinationArn) {
        this.destinationArn = destinationArn;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AccessLogSettings) == false) {
            return false;
        }
        AccessLogSettings rhs = ((AccessLogSettings) other);
