    ...
    implements HasCondition<ApplicationOutputResource> , HasDependsOn<ApplicationOutputResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::KinesisAnalyticsV2::ApplicationOutput";
    /**
     * ApplicationOutput
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationoutput.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationoutput.html")
