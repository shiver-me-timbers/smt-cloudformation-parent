...
public class MonitoringConfiguration implements Property<MonitoringConfiguration>
{
    ...
    public MonitoringConfiguration withConfigurationType(CharSequence configurationType) {
        this.configurationType = configurationType;
        return this;
    }
    ...
    public MonitoringConfiguration withMetricsLevel(CharSequence metricsLevel) {
        this.metricsLevel = metricsLevel;
        return this;
    }
    ...
    public MonitoringConfiguration withLogLevel(CharSequence logLevel) {
        this.logLevel = logLevel;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MonitoringConfiguration) == false) {
            return false;
        }
        MonitoringConfiguration rhs = ((MonitoringConfiguration) other);
