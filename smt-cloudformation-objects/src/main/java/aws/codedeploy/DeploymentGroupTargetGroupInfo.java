...
public class DeploymentGroupTargetGroupInfo implements Property<DeploymentGroupTargetGroupInfo>
{
    ...
    public DeploymentGroupTargetGroupInfo withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeploymentGroupTargetGroupInfo) == false) {
            return false;
        }
        DeploymentGroupTargetGroupInfo rhs = ((DeploymentGroupTargetGroupInfo) other);
