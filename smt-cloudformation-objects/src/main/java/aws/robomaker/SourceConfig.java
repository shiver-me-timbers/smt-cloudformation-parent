...
public class SourceConfig implements Property<SourceConfig>
{
    ...
    public SourceConfig withS3Bucket(CharSequence s3Bucket) {
        this.s3Bucket = s3Bucket;
        return this;
    }
    ...
    public SourceConfig withArchitecture(CharSequence architecture) {
        this.architecture = architecture;
        return this;
    }
    ...
    public SourceConfig withS3Key(CharSequence s3Key) {
        this.s3Key = s3Key;
        return this;
    }
