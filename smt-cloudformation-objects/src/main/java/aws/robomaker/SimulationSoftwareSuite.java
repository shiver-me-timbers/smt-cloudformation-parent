...
public class SimulationSoftwareSuite implements Property<SimulationSoftwareSuite>
{
    ...
    public SimulationSoftwareSuite withVersion(CharSequence version) {
        this.version = version;
        return this;
    }
    ...
    public SimulationSoftwareSuite withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SimulationSoftwareSuite) == false) {
            return false;
        }
        SimulationSoftwareSuite rhs = ((SimulationSoftwareSuite) other);
