...
public class RenderingEngine implements Property<RenderingEngine>
{
    ...
    public RenderingEngine withVersion(CharSequence version) {
        this.version = version;
        return this;
    }
    ...
    public RenderingEngine withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RenderingEngine) == false) {
            return false;
        }
        RenderingEngine rhs = ((RenderingEngine) other);
