...
public class EngineAttribute implements Property<EngineAttribute>
{
    ...
    public EngineAttribute withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public EngineAttribute withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EngineAttribute) == false) {
            return false;
        }
        EngineAttribute rhs = ((EngineAttribute) other);
