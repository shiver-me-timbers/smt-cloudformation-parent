...
public class FileAccessLog implements Property<FileAccessLog>
{
    ...
    public FileAccessLog withPath(CharSequence path) {
        this.path = path;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FileAccessLog) == false) {
            return false;
        }
        FileAccessLog rhs = ((FileAccessLog) other);
