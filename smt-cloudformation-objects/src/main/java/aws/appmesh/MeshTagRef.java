...
public class MeshTagRef implements Property<MeshTagRef>
{
    ...
    public MeshTagRef withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public MeshTagRef withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MeshTagRef) == false) {
            return false;
        }
        MeshTagRef rhs = ((MeshTagRef) other);
