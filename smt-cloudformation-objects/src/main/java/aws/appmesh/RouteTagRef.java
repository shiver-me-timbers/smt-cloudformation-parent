...
public class RouteTagRef implements Property<RouteTagRef>
{
     ...
     */
    @JsonProperty("Value")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-tagref.html#cfn-appmesh-route-tagref-value")
     ...
     */
    @JsonProperty("Key")
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-tagref.html#cfn-appmesh-route-tagref-key")
    ...
    public RouteTagRef withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public RouteTagRef withKey(CharSequence key) {
        this.key = key;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RouteTagRef) == false) {
            return false;
        }
        RouteTagRef rhs = ((RouteTagRef) other);
