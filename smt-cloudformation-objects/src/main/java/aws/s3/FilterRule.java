...
public class FilterRule implements Property<FilterRule>
{
    ...
    public FilterRule withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public FilterRule withValue(CharSequence value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FilterRule) == false) {
            return false;
        }
        FilterRule rhs = ((FilterRule) other);
