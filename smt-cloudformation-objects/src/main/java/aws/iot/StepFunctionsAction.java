...
public class StepFunctionsAction implements Property<StepFunctionsAction>
{
    ...
    public StepFunctionsAction withExecutionNamePrefix(CharSequence executionNamePrefix) {
        this.executionNamePrefix = executionNamePrefix;
        return this;
    }
    ...
    public StepFunctionsAction withRoleArn(CharSequence roleArn) {
        this.roleArn = roleArn;
        return this;
    }
    ...
    public StepFunctionsAction withStateMachineName(CharSequence stateMachineName) {
        this.stateMachineName = stateMachineName;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StepFunctionsAction) == false) {
            return false;
        }
        StepFunctionsAction rhs = ((StepFunctionsAction) other);
