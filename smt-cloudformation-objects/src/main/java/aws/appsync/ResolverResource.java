...
public class ResolverResource
    extends Resource
    implements HasAttributes<ResolverAttributes> , HasCondition<ResolverResource> , HasDependsOn<ResolverResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::AppSync::Resolver";
    /**
     * Resolver
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appsync-resolver.html
