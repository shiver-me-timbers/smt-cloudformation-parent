...
public class UserPolicy implements Property<UserPolicy>
{
    ...
    public UserPolicy withPolicyDocument(Property<PolicyDocument> policyDocument) {
        this.policyDocument = policyDocument;
        return this;
    }
    ...
    public UserPolicy withPolicyName(CharSequence policyName) {
        this.policyName = policyName;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UserPolicy) == false) {
            return false;
        }
        UserPolicy rhs = ((UserPolicy) other);
