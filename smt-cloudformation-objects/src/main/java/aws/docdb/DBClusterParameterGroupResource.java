...
public class DBClusterParameterGroupResource
    extends Resource
    implements HasCondition<DBClusterParameterGroupResource> , HasDependsOn<DBClusterParameterGroupResource>
{

    @JsonProperty("Type")
    private java.lang.String type = "AWS::DocDB::DBClusterParameterGroup";
    /**
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-docdb-dbclusterparametergroup.html")
