    ...
    implements HasAttributes<DBInstanceAttributes> , HasCondition<DBInstanceResource> , HasDependsOn<DBInstanceResource>
{
    ...
    @JsonProperty("Type")
    private java.lang.String type = "AWS::DocDB::DBInstance";
    /**
     * DBInstance
     * <p>
     * http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-docdb-dbinstance.html
    ...
    @JsonPropertyDescription("http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-docdb-dbinstance.html")
