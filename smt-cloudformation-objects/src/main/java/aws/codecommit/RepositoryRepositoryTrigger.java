...
public class RepositoryRepositoryTrigger implements Property<RepositoryRepositoryTrigger>
{
    ...
    public RepositoryRepositoryTrigger withEvents(List<CharSequence> events) {
        this.events = events;
        return this;
    }
    ...
    public RepositoryRepositoryTrigger withBranches(List<CharSequence> branches) {
        this.branches = branches;
        return this;
    }
    ...
    public RepositoryRepositoryTrigger withCustomData(CharSequence customData) {
        this.customData = customData;
        return this;
    }
    ...
    public RepositoryRepositoryTrigger withDestinationArn(CharSequence destinationArn) {
        this.destinationArn = destinationArn;
        return this;
    }
    ...
    public RepositoryRepositoryTrigger withName(CharSequence name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RepositoryRepositoryTrigger) == false) {
            return false;
        }
        RepositoryRepositoryTrigger rhs = ((RepositoryRepositoryTrigger) other);
